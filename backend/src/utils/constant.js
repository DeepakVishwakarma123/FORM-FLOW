...
return [senderKeyArray,remainingFieldKeysArray]
 ...
 let schemaRules=  {
       ...
       "h-captcha-response":joi.string().strip(true),
       "g-recaptcha-response":joi.string().strip(true),
       "cf-turnstile-response":joi.string().strip(true)
    }
...
/* 
this functinon is use as universal function 
across each captcha to evalute their server site verify response
by its success field value true or false */
